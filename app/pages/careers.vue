  ...
  <div class="careers-page bg-white dark:bg-gray-900">
    ...
    <section class="hero bg-brandcomp text-white py-20">
      <div class="container mx-auto px-4">
        ...
        <p class="text-xl md:text-2xl dark:text-branddim-200">Join our team and help build a more secure and private
          internet.</p>
      </div>
    </section>
    ...
    <section class="py-16 bg-brandcompdim-800">
      <div class="container mx-auto px-4">
        ...
        <p class="text-xl text-center max-w-3xl mx-auto text-gray-800 dark:text-gray-300">
          ...
          sex, sexual orientation, gender identity, salad preference, national origin, disability, or any other legally
          protected
          status.
        </p>
      </div>
    ...
    <section v-if="showContactUs"
      ...
      <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl mb-8 text-gray-800 dark:text-gray-300">If you have any questions or would like to learn more
          about our company, please reach out to us.</p>
        <span class="text-brandcomp text-xl font-semibold hover:underline">
          <span class="email"
                data-subject="Speedy Job Application Inquiry">careerspeed &#65;&#84; onetimesecret D0T com</span>
        </span>
      </div>
    </section>
  </div>
