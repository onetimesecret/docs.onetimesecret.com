  ...
  return (
    <div className="flex h-full items-center justify-center bg-gray-100 p-4">
      <div className="w-full max-w-md">
        {/* Header */}
        <div className="mb-4 rounded-t-lg bg-gray-700 px-6 py-4">
          <h1 className="text-lg font-medium text-white">Sign in to your account</h1>
        </div>
        ...
        <div className="rounded-b-lg bg-white p-6 shadow">
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label htmlFor="keycloak-remember" className="flex items-center gap-2 text-sm text-gray-600">
          ...
          <div className="mt-6 border-t border-gray-200 pt-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 rounded border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">
        ...
        <div className="mt-4 text-center text-xs text-gray-500">
          Powered by <span className="font-medium">Keycloak</span>
        </div>
      </div>
    </div>
  );
