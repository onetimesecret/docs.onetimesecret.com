---
title: Oversigt
description: Løft dit brand og forbedr din professionelle beskeddelingsoplevelse med brugerdefinerede domæner, en avanceret funktion til agenturer, virksomheder og power-brugere.
---

## Hvad er brugerdefinerede domæner?

Brugerdefinerede domæner giver dig mulighed for at bruge dit eget domænenavn til Onetime Secret-links i stedet for standard _onetimesecret.com_-domænet. Denne funktion inkorporerer din brandidentitet i beskeddelingsoplevelsen, hvilket forbedrer tillid og professionalisme.
...
1. **Brandidentitet**: Del beskeder ved hjælp af dit eget domænenavn, hvilket forstærker sikkerhed og professionalisme.
2. **Øget tillid**: Modtagere ser et velkendt domæne, hvilket øger deres tillid til den delte information.
...
For at opsætte et brugerdefineret domæne:
...
Brugere af brugerdefinerede domæner kan personalisere deres beskeddelingsgrænseflade:

1. Upload virksomhedslogo (PNG/JPG, maks. 1 MB)
2. Indstil brugerdefinerede brandfarver ved hjælp af hex-koder
3. Konfigurer synlighedsindstillinger for hjemmeside
4. Forhåndsvis ændringer i realtid
5. Aktiver/deaktiver offentlig beskedoprettelse

For detaljerede brandinginstruktioner, se vores [Brandvejledning](/da/custom-domains/brand-guide).

## Vigtige overvejelser

- Brugerdefinerede domæner er en premiumfunktion tilgængelig med Identity-planen.
