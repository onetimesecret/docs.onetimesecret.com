---
title: Oversættelsesstilvejledning
description: En omfattende vejledning til oversættere, der arbejder med lokalisering af Onetime Secret, der dækker brandets stemme, terminologistandarder og sprogspecifikke krav for at sikre oversættelser af høj kvalitet og konsistens
---

## Oversættelsesstilvejledning Dansk (da)

![Oversættelsesstilvejledning](/socialcards/onetime-socialcard-20250226-1.png)

Denne stilvejledning giver instruktioner til oversættelse til dansk.

| *Denne stilvejledning er baseret på indhold fra [Mozilla L10N Styleguides](https://github.com/mozilla-l10n/styleguides/) af Mozilla Contributors, licenseret under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).*  |
|  |

## Målgruppe

Vores dansksprogede målgruppe omfatter:

### Kunder

- Professionel baggrund: IT-professionelle, bureauteams (design, udvikling, marketing) og virksomhedssupportteams (HR, provisionering, logistik, finans)
...
- Målgruppe: Bred aldersgruppe (18-80), herunder studerende, seniorer, forældre, klienter, kolleger. Disse personer har muligvis aldrig hørt om Onetime Secret og har generelt mindre kontekst omkring, hvordan det fungerer.
...
*Vejledning: Identificer regler for grammatik, stil og tegnsætning for at opretholde konsistens gennem alt dit oversatte indhold.*
...
- Generelt brug anden person (`du`) til at henvende sig til brugeren.
- Undgå at bruge første person (`min`, `jeg`), da det kan skabe forvirring om, hvem der bliver tiltalt.

### UI-tekst: Hvornår skal man bruge aktiv vs. passiv stemme

#### Aktiv, imperativ stemme ("Gør noget")
...
✓ Upload i gang
✓ Forbindelse mistet
✓ E-mailadresse ikke fundet

#### Eksempler i kontekst

Formularindsendelse
✓ Gem ændringer (knap->aktiv)
✓ Ændringer gemt (status->passiv)

Filopload
✓ Upload fil (knap)
✓ Upload fuldført (status)

## Terminologikonsistens

*Opret en ordliste over nøgletermer sammen med deres godkendte oversættelser for at sikre konsistent brug på tværs af alt indhold.*
...
I "Onetime Secret" fungerer "Onetime" som et sammensat adjektiv (også kaldet et attributivt adjektiv), der modificerer substantivet "Secret". Det beskriver en nøglekarakteristik ved beskeden - at den kun kan tilgås én gang. Bemærk stavemåden. Der er faktisk tre almindelige varianter af dette begreb:
...
- **besked** (n.) - Den fortrolige information, der deles
...
- **kryptering** (n.) - Processen med at kode beskeder
...
#### Oversættelse af ordet "secret"

Ordet "besked" er centralt for vores brand, produkt og kommunikationsstrategi. Vi beskytter beskeder. Vi leverer også en hemmelig tjeneste.

Ordet secret kan have en række betydninger med subtile, men vigtige forskelle. Vort kanoniske eksempel kommer fra en opdatering til vores danske oversættelse af [jetdk](https://github.com/onetimesecret/onetimesecret/pull/956#issue-2782747525):

##### Ordvalg: "Beskeder" vs "Hemmeligheder"

KORREKT:   **Beskeder** (beskeder)
FORKERT: Hemmeligheder (hemmeligheder)
...
✅ Du har 3 nye beskeder (Du har 3 nye beskeder)
❌ Du har 3 nye hemmeligheder (Du har 3 nye hemmeligheder)

#### Hvornår anvendes "besked"-undtagelsen

Den danske undtagelse (brug af "besked" i stedet for "hemmelighed") bør KUN anvendes, når ALLE følgende betingelser er opfyldt:

1. **Den bogstavelige oversættelse af "secret" bærer upassende konnotationer** på målsproget
2. **Disse konnotationer undergraver specifikt den professionelle/sikkerhedskontekst**, såsom:
...
3. **Indfødte talere bekræfter, at sikkerhedsrammen går tabt**, når den bogstavelige oversættelse bruges
...
1. **Test den bogstavelige oversættelse** med indfødte talere, der ikke kender produktet
2. **Spørg:** Lyder "[Opret en besked]" professionelt og sikkerhedsfokuseret?
3. **Hvis JA:** Brug den bogstavelige oversættelse (som tysk "Geheimnis", polsk "Sekret")
4. **Hvis NEJ:** Overvej "besked"-undtagelsen (som dansk "Beskeder")
...
Onetime Secret skelner vigtigt mellem to sikkerhedskoncepter, der konsekvent skal opretholdes på tværs af alle oversættelser:

#### Adgangskode

- **Definition**: En standard godkendelseslegitimation, der bruges til kontoadgang
...
- **Definition**: En sikkerhedsforanstaltning specifikt til beskyttelse af individuelle beskeder
...
Forskellige sprog håndterer denne distinktion på forskellige måder:
...
1. Bevar altid konsistent skelnen mellem de to koncepter
2. Test dine valgte termer med indfødte talere, der ikke kender produktet
3. Sørg for, at adgangssætningstermen formidler yderligere sikkerhed/kompleksitet sammenlignet med adgangskode
4. Brug nøjagtig samme term for hvert koncept gennem hele oversættelsen

✅ Korrekt tilgang:
Kontosektion: "Indtast din [ADGANGSKODE] for at logge ind"
Beskedsektion: "Denne besked er beskyttet med en [ADGANGSSÆTNING]"

❌ Forkert tilgang:
Brug af samme term til begge koncepter, eller inkonsekvent skifte mellem termer

#### Brugerstyring

- **colonel** (n.) - Administratorrolle
...
*Sæt standarder for formatering, layout og typografi for at opretholde visuel og designkonsistens på tværs af forskellige sprog.*
...
Generelt bruges et 24-timers ur i Danmark.
...
Valutaen i Danmark er den danske krone (DKK). Det monetære symbol er `kr`.

### Måleenheder

Det metriske system bruges til alle vægte og afstande i Danmark. Primært m, Km, cm, mm, kg, g.
...
## Klar, respektfuld kommunikation

Vores mål: Vi ønsker, at vores skrivning forbinder effektivt med alle læsere, samtidig med at den er klar, præcis og respektfuld.
...
- Brug bogstavelig oversættelse til juridiske eller tekniske tekster
