...
2. **Швидка дія**: Якщо ви підозрюєте, що секрет було скомпрометовано, негайно скористайтеся функцією знищення Onetime Secret, якщо секрет ще не був переглянутий. Якщо секрет був переглянутий, вживіть відповідних заходів, щоб зменшити потенційну шкоду.
