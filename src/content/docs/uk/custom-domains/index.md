...
Докладні інструкції, зокрема про те, як вибрати між регіонами ЄС і США, можна знайти в нашому [Посібнику з налаштування користувацьких доменів](/uk/custom-domains/setup-guide).
...
- Враховуйте правила захисту даних при виборі між [регіонами ЄС і США](/uk/regions).
