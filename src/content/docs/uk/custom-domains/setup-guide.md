...
Onetime Secret пропонує кілька регіонів розташування дата-центрів: EU, UK, US, CA та NZ. Під час налаштування власного домену вам потрібно буде вибрати, якому регіону ви віддаєте перевагу для зберігання даних. Цей вибір важливий з кількох причин:
...
При виборі враховуйте ваші конкретні потреби та вимоги. Для отримання більш детальної інформації про регіони розташування наших дата-центрів і про те, як вибрати відповідний для ваших потреб, зверніться до нашого посібника [Регіони розташування дата-центрів](/uk/regions).
...
2. Створіть запис CNAME з такими даними:
   ...
   - Вказує на / Значення:
     - Для регіону CA: identity.ca.onetime.co
     - Для регіону EU: identity.eu.onetime.co
     - Для регіону NZ: identity.nz.onetime.co
     - Для регіону UK: identity.ingress.onetime.co (anycast)
     - Для регіону US: identity.us.onetime.co
...
2. Створіть або змініть запис A з такими даними:
   ...
   - Вказує на / Значення:
     - Для регіону EU: 109.105.217.207
     - Для регіону US: 66.51.126.41
     - Для інших регіонів: зверніться до служби підтримки, щоб дізнатися актуальні IP-адреси A-записів
...
- Цільова адреса: ідентифікаційна кінцева точка для обраного вами регіону (наприклад, identity.ca.onetime.co, identity.eu.onetime.co, identity.nz.onetime.co, identity.ingress.onetime.co, identity.us.onetime.co)
- Статус SSL: Активний
...
Після активації ваші таємні посилання будуть використовувати ваш власний домен. Наприклад:
