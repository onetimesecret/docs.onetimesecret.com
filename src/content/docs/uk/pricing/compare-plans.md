...
description: Порівняйте наші багатофункціональні плани, що пропонують безпечний обмін таємними даними з посиланнями, термін дії яких закінчується, користувацькі домени та гнучкі варіанти зберігання для приватних осіб і компаній.
---


## Матриця функцій

| Особливості/план | Identity Plus | Базовий | Без входу |
|---------|----------------|-------------------------|------------|
...
| Безпека SSL/TLS | ✅ | ✅ | ✅ |
| Місцезнаходження даних | ✅ (ЄС або США) | ✅ (ЄС або США) | ✅ (ЄС або США) |
