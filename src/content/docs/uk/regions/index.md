...
- **Відсутність міжцентральних операцій**: Ви не можете виконувати операції (наприклад, спалювати таємницю) між центрами обробки даних. Кожен центр зберігає свій власний набір таємниць і даних користувачів.
...
- Місцезнаходження вашої таємниці завжди видно зі згенерованого посилання (наприклад, `us.onetimesecret.com/secret/abcd1234`).
...
- Існуючі облікові записи і таємниці залишаються в їх початковому центрі обробки даних.

### Для всіх користувачів

- Таємниці, створені без юрисдикції субдомену (наприклад, onetimesecret.com/secret/efgh5678), продовжуватимуть за замовчуванням зберігатися в нашому дата-центрі в ЄС.
...
3. Для кастомних доменів: Вкажіть обраний регіон під час налаштування параметрів DNS (докладні інструкції див. в нашому [Посібнику з налаштування користувацьких доменів](/uk/custom-domains/setup-guide)).
...
- Таємні посилання, які ви створили, продовжуватимуть працювати, доки їх не переглянуть або вони не закінчаться
