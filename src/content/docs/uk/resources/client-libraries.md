...
description: Ознайомтеся з клієнтськими бібліотеками для API Onetime Secret, включаючи Ruby, Python, Perl, Java, C#, Go та інші.
---

## Ruby


[Сторінка Github onetime-ruby](https://github.com/onetimesecret/onetime-ruby)
автор [Delano](https://delanotes.com/) (оновлено 2024-06-09)
...
автор [slashpass](https://github.com/slashpass) (додано 2021-07-08)
...
[Сторінка Github - py\_onetimesecret](https://github.com/utter-step/py_onetimesecret)
автор [Vladislav Stepanov](https://github.com/utter-step/) (додано 2012-06-26)
...
автор [Kyle Dawkins](http://www.shoffle.com/) (додано 2012-01-06)
...
[Сторінка Github - onetime-java](https://github.com/mpawlowski/onetime-java)
автор [Marcin Pawlowski](https://github.com/mpawlowski) (додано 2014-05-22)
...
[Сторінка Github - OneTimeSharp](https://github.com/utter-step/OneTimeSharp)
автор [Vladislav Stepanov](https://github.com/utter-step/) (додано 2014-05-29)
...
[Сторінка Github - onetimesecret](https://github.com/corbaltcode/go-onetimesecret)
автор [Corbalt](https://github.com/corbaltcode/) (додано 2021-12-10)
...
[Сторінка Github](https://github.com/emdneto/otsgo)
автор [Emídio Neto](https://github.com/emdneto) (додано 2024-06-09)
...
[Сторінка Github - OneTimeSecret](https://github.com/chelnak/OneTimeSecret)
автор [Craig Gumbley](https://www.helloitscraig.co.uk) (оновлено 2017-04-28)
...
[Сторінка Github - OneTimeSecret-bash](https://github.com/eengstrom/onetimesecret-bash)
автор [Eric Engstrom](https://eengstrom.github.io/) (оновлено 2018-12-19)

### Приклад використання як Scripting API
