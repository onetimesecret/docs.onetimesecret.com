...
description: Benutzerdefinierte Domains ermöglichen es dir, geheime Freigaben unter deinem eigenen Domainnamen zu hosten, mit DNS-Konfiguration in EU- oder US-Rechenzentren und optionalen Funktionen zur Markenanpassung.
---


## deine Marke, unsere du?cherheit
Durch die Nutzung von Custom Domains geben du nicht nur Geheimnisse weiter, sondern stärken auch deine Marke, erhöhen das Vertrauen und gewährleisten die Einhaltung der Datenlokalisierung bei jeder Interaktion. Erwerben du noch heute ein Upgrade auf den Identity-Plan, um diese leistungsstarke Funktion freizuschalten und den Austausch von Geheimnissen auf die nächste Stufe zu bringen.
...
- **DNS-Verbreitung**: Es kann bis zu 48 Stunden dauern, bis die Änderungen vollständig übertragen sind. Seien du geduldig und versuchen du es später noch einmal, wenn die Überprüfung zunächst fehlschlägt.
