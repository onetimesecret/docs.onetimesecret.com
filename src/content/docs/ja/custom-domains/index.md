...
6. **地域の柔軟性**: お客様のデータ地域のニーズに合わせて、5つのデータセンター地域（EU、UK、US、CA、NZ）からお選びいただけます。
...
4.ご希望のデータセンター地域（EU、UK、US、CA、またはNZ）を選択します。
5.DNS設定のために提供されるステップバイステップの指示に従ってください。
6.ドメインが検証されるのを待ちます。利用可能な場合は、"Verify "ボタンをクリックして、プロセスを促進します。ページを更新する必要があるかもしれません。

リージョンの選択方法を含む詳細な手順については、[カスタムドメイン設定ガイド](/ja/custom-domains/setup-guide)を参照してください。
...
ブランディングの詳細については、[ブランドガイド](/ja/custom-domains/brand-guide)をご覧ください。
...
- [データセンター地域](/ja/regions)を選択する際は、データ保護規制を考慮してください。
