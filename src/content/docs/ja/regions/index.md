...
2.**レイテンシー**：主要なユーザーベースに近い地域を選択することで、レイテンシーを減らすことができる。
...
- あなたのシークレットの場所は、生成されたリンク（例 `us.onetimesecret.com/secret/abcd1234`）から常に明らかです。
...
3.カスタムドメインの場合：DNS設定の際に選択した地域を指定してください（詳細な手順については、[カスタムドメイン設定ガイド](/ja/custom-domains/setup-guide)を参照してください）。
