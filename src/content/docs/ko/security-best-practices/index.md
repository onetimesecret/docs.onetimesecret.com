---
title: 보안 모범 사례
description: 사용자 지정 도메인의 보안 이점을 포함하여 Onetime Secret과 관련된 이러한 모범 사례를 통해 비밀 공유 보안을 강화하세요.
---

Onetime Secret은 보안을 염두에 두고 설계되었지만, 특히 사용자 지정 도메인과 같은 기능을 사용할 때 이러한 모범 사례를 따르면 민감한 정보를 더욱 안전하게 보호할 수 있습니다.
...
사용자 정의 도메인을 Onetime Secret과 함께 사용하면 몇 가지 보안상의 이점이 있습니다:
...
이러한 모범 사례를 따르면 Onetime Secret에서 비밀 공유 활동의 보안을 크게 강화할 수 있습니다. 보안은 지속적인 프로세스이며, 민감한 정보를 보호하기 위해서는 경계를 늦추지 않는 것이 중요합니다.
