---
title: 어떻게 작동하나요?
description: 사용자 지정 도메인을 사용하면 당사의 모든 데이터 센터 지역에서 DNS 구성과 선택적 브랜드 사용자 지정 기능을 통해 자신의 도메인 이름으로 비밀 공유를 호스팅할 수 있습니다.
---
...
2. 선호하는 데이터 센터 지역을 선택합니다.
3. [도메인의 DNS 설정 구성](/ko/custom-domains/setup-guide)에서 선택한 지역에 있는 Onetime Secret의 서버를 가리키도록 설정합니다.
4. Onetime Secret 계정 설정에서 사용자 지정 도메인을 설정합니다.
