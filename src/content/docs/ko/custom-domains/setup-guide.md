...
- 사용자 지정 도메인 기능을 사용하도록 설정한 활성 Onetime Secret 계정
...
데이터 센터 지역을 선택할 때는 회원님의 구체적인 필요와 요구사항을 고려하세요. 데이터 센터 지역에 대한 자세한 정보와 필요에 맞는 데이터 센터 지역을 선택하는 방법은 [데이터 센터 지역](/ko/regions) 가이드를 참조하세요.
