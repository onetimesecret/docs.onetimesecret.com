---
title: Översikt
description: Förhöj ditt varumärke och förbättra din professionella hemlighetsdelningstjänst med anpassade domäner, en avancerad funktion för byråer, företag och avancerade användare.
---

## Vad är anpassade domäner?

Anpassade domäner låter dig använda ditt eget domännamn för Onetime Secret-länkar, istället för standarddomänen _onetimesecret.com_. Denna funktion integrerar din varumärkesidentitet i hemlighetsdelningstjänsten, vilket förbättrar förtroende och professionalism.
...
1. **Varumärkesidentitet**: Dela hemligheter med ditt eget domännamn, vilket förstärker säkerhet och professionalism.
2. **Ökat förtroende**: Mottagare ser en bekant domän, vilket ökar deras förtroende för den delade informationen.
...
För att konfigurera en anpassad domän:
...
Användare av anpassade domäner kan anpassa sitt hemlighetsdel ningsgränssnitt:

1. Ladda upp företagslogotyp (PNG/JPG, max 1MB)
2. Ställ in anpassade varumärkesfärger med hex-koder
3. Konfigurera inställningar för startsidans synlighet
4. Förhandsgranska ändringar i realtid
5. Aktivera/inaktivera offentlig hemlighetsskapande

För detaljerade varumärkesinstruktioner, se vår [Varumärkesguide](/sv/custom-domains/brand-guide).

## Viktiga överväganden

- Anpassade domäner är en premiumfunktion tillgänglig med Identity-planen.
