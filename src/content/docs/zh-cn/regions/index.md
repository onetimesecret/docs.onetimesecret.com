...
- 从生成的链接（例如 "us.onetimesecret.com/secret/abcd1234"）中，您的内容存储位置总是一目了然。
...
- 在没有子域管辖的情况下创建的内容（例如，onetimesecret.com/secret/efgh5678）将继续默认使用我们的欧盟数据中心。
...
3.对于自定义域名：在配置 DNS 设置时指定您选择的地区（详细说明请参阅我们的 [自定义域名设置指南](/zh-cn/custom-domains/setup-guide)）。
