...
3.3. [配置域名的 DNS 设置](custom-domains/setup-guide) 以指向您所选地区的 Onetime Secret 服务器。
4.在 Onetime Secret 账户设置中设置自定义域名。
5.验证通过后，您的秘密链接将使用您的自定义域名。
6.通过管理界面[自定义域名外观](custom-domains/brand-guide) 添加徽标和品牌颜色。
...
- **地区选择**：如果您不确定选择哪个地区，请查阅我们的[数据中心地区](regions)指南或联系我们的支持团队。

要了解安全使用自定义域的最佳实践，请查看我们的 [安全最佳实践](security-best-practices) 指南。
