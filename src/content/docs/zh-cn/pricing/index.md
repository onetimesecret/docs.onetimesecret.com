...
[查看当前价格](https://onetimesecret.com/pricing)

## 常见问题

### Onetime Secret是如何工作的？
Onetime Secret让您可以安全地共享敏感信息。每条共享的机密信息在被永久删除前只能被查看一次，从而确保数据的机密性。

### 使用 Onetime Secret 需要账户吗？
基本功能不需要账户。您可以立即开始共享机密信息，无需进行复杂的设置。
...
我们非常重视安全问题，并采取多种措施保护用户的信息。正如我们的隐私政策所述，我们采用符合行业标准的做法来保护所有数据，防止未经授权的访问、篡改或破坏。所有传输中的数据均使用HTTPS/TLS加密，静态数据安全存储在您所选择的数据中心区域——加拿大、欧盟、新西兰、英国或美国——并符合该区域适用的数据保护法律。
