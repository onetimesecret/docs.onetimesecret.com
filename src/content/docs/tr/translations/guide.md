---
title: Çeviri Stil Kılavuzu
description: Onetime Secret yerelleştirmesi üzerinde çalışan çevirmenler için marka sesi, terminoloji standartları ve dile özgü gereksinimleri kapsayan kapsamlı kılavuz - yüksek kaliteli ve tutarlı çeviriler sağlamak için
---

## Çeviri Stil Kılavuzu Türkçe (tr-TR)

![Çeviri Stil Kılavuzu](/socialcards/onetime-socialcard-20250226-1.png)
...
#### Aktif, Emir Kipi Ses ("Bir şey yap")
...
Form gönderimi
✓ Değişiklikleri kaydet (düğme->aktif)
✓ Değişiklikler başarıyla kaydedildi (durum->pasif)

Dosya yükleme
✓ Dosya yükle (düğme)
✓ Yükleme tamamlandı (durum)
...
| Dil | Password (Hesap) | Passphrase (Gizli Mesaj Koruması) | Notlar |
|----------|-------------------|------------------------------|-------|
...
✅ Doğru yaklaşım:
Hesap bölümü: "Giriş yapmak için [PAROLA] nızı girin"
Gizli mesaj bölümü: "Bu gizli mesaj bir [GÜVENLİK İFADESİ] ile korunmaktadır"

❌ Yanlış yaklaşım:
Her iki kavram için aynı terimi kullanmak veya terimler arasında tutarsızca geçiş yapmak
...
|  Sembol Amacı  |  Karakter Adı  |  Sembol  |  Örnek  |
| --- | --- | --- | --- |
|  Ondalık  |  Virgül  |  `,`  |  1,23  |
|  Binler  |  Nokta  |  `.`  |  1.234  |
|  Yüzde  |  Yüzde işareti  |  `%`  |  %99,95  |
