---
title: Genel Bakış
description: Ajanslar, işletmeler ve profesyonel kullanıcılar için gelişmiş bir özellik olan Özel Alan Adları ile markanızı yükseltin ve profesyonel gizli mesaj paylaşım deneyiminizi geliştirin.
---

## Özel Alan Adları Nedir?

Özel Alan Adları, varsayılan _onetimesecret.com_ alan adı yerine Onetime Secret bağlantıları için kendi alan adınızı kullanmanıza olanak tanır. Bu özellik, marka kimliğinizi gizli mesaj paylaşım deneyimine dahil ederek güveni ve profesyonelliği artırır.
...
1. **Marka Kimliği**: Kendi alan adınızı kullanarak gizli mesaj paylaşın, güvenliği ve profesyonelliği pekiştirin.
2. **Artan Güven**: Alıcılar tanıdık bir alan adı görür, paylaşılan bilgilere olan güvenleri artar.
...
Özel Alan Adı kullanıcıları gizli mesaj paylaşım arayüzlerini kişiselleştirebilir:

1. Şirket logosu yükle (PNG/JPG, maks 1MB)
2. Hex kodlarını kullanarak özel marka renkleri ayarla
3. Ana sayfa görünürlük ayarlarını yapılandır
4. Değişiklikleri gerçek zamanlı olarak önizle
5. Genel gizli mesaj oluşturmayı etkinleştir/devre dışı bırak

Ayrıntılı markalama talimatları için [Marka Kılavuzumuza](/tr/custom-domains/brand-guide) bakın.


## Önemli Hususlar

- Özel Alan Adları, Identity planıyla birlikte sunulan premium bir özelliktir.
