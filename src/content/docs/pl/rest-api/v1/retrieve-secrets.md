...
- Wybierz [region]({getRelativeLocaleUrl(Astro.currentLocale ?? 'en', 'regions')}) (np. [`us.onetimesecret.com`](https://us.onetimesecret.com/), [`eu.onetimesecret.com`](https://eu.onetimesecret.com/)) centra danych
