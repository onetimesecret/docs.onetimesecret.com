---
title: Biblioteki klienckie
description: Poznaj biblioteki klienckie dostępne dla API Onetime Secret, w tym Ruby, Python, Perl, Java, C#, Go i inne.
---

## Ruby


[Strona Github onetime-ruby](https://github.com/onetimesecret/onetime-ruby)
przez [Delano](https://delanotes.com/) (zaktualizowano 2024-06-09)
...
[Strona Github - onetimesecret-cli](https://github.com/slashpass/onetimesecret-cli)
przez [slashpass](https://github.com/slashpass) (dodano 2021-07-08)
...
[Strona Github - py\_onetimesecret](https://github.com/utter-step/py_onetimesecret)
przez [Vladislav Stepanov](https://github.com/utter-step/) (dodano 2012-06-26)
...
[Net::OneTimeSecret na CPAN](http://search.cpan.org/~kyled/Net-OneTimeSecret/lib/Net/OneTimeSecret.pm)
przez [Kyle Dawkins](http://www.shoffle.com/) (dodano 2012-01-06)
...
[Strona Github - onetime-java](https://github.com/mpawlowski/onetime-java)
przez [Marcin Pawlowski](https://github.com/mpawlowski) (dodano 2014-05-22)
...
[Strona Github - OneTimeSharp](https://github.com/utter-step/OneTimeSharp)
przez [Vladislav Stepanov](https://github.com/utter-step/) (dodano 2014-05-29)
...
[Strona Github - onetimesecret](https://github.com/corbaltcode/go-onetimesecret)
przez [Corbalt](https://github.com/corbaltcode/) (dodano 2021-12-10)
...
[Strona Github](https://github.com/emdneto/otsgo)
przez [Emídio Neto](https://github.com/emdneto) (dodano 2024-06-09)
...
[Strona Github - OneTimeSecret](https://github.com/chelnak/OneTimeSecret)
przez [Craig Gumbley](https://www.helloitscraig.co.uk) (zaktualizowano 2017-04-28)
...
[Strona Github - OneTimeSecret-bash](https://github.com/eengstrom/onetimesecret-bash)
przez [Eric Engstrom](https://eengstrom.github.io/) (zaktualizowano 2018-12-19)

### Przykład użycia jako API skryptowe
