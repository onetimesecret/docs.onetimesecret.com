---
title: Przegląd
description: Podnieś swoją markę i wzmocnij profesjonalne doświadczenie udostępniania sekretów dzięki niestandardowym domenom, zaawansowanej funkcji dla agencji, firm i zaawansowanych użytkowników.
---

## Czym są niestandardowe domeny?

Niestandardowe domeny pozwalają używać własnej nazwy domeny dla linków Onetime Secret, zamiast domyślnej domeny _onetimesecret.com_. Ta funkcja włącza tożsamość Twojej marki do doświadczenia udostępniania sekretów, zwiększając zaufanie i profesjonalizm.
...
1. **Tożsamość marki**: Udostępniaj sekrety używając własnej nazwy domeny, wzmacniając bezpieczeństwo i profesjonalizm.
2. **Zwiększone zaufanie**: Odbiorcy widzą znajomą domenę, zwiększając ich pewność w udostępnianych informacjach.
...
Użytkownicy niestandardowych domen mogą personalizować swój interfejs udostępniania sekretów:

1. Prześlij logo firmy (PNG/JPG, maks. 1MB)
2. Ustaw niestandardowe kolory marki używając kodów hex
3. Skonfiguruj ustawienia widoczności strony głównej
4. Przeglądaj zmiany w czasie rzeczywistym
5. Włącz/wyłącz publiczne tworzenie sekretów

Po szczegółowe instrukcje brandingowe zobacz nasz [Przewodnik marki](/pl/custom-domains/brand-guide).


## Ważne uwagi

- Niestandardowe domeny to funkcja premium dostępna z planem Identity.
