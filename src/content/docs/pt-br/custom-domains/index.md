---
title: Visão Geral
description: Eleve sua marca e melhore sua experiência profissional de compartilhamento de mensagens com Domínios Personalizados, um recurso avançado para agências, empresas e usuários avançados.
---

## O Que São Domínios Personalizados?

Domínios Personalizados permitem que você use seu próprio nome de domínio para links do Onetime Secret, em vez do domínio padrão _onetimesecret.com_. Este recurso incorpora a identidade da sua marca na experiência de compartilhamento de mensagens, aumentando a confiança e o profissionalismo.
...
1. **Identidade de Marca**: Compartilhe mensagens usando seu próprio nome de domínio, reforçando segurança e profissionalismo.
2. **Maior Confiança**: Os destinatários veem um domínio familiar, aumentando sua confiança nas informações compartilhadas.
...
Usuários de Domínio Personalizado podem personalizar sua interface de compartilhamento de mensagens:

1. Faça upload do logotipo da empresa (PNG/JPG, máx. 1MB)
2. Defina cores de marca personalizadas usando códigos hexadecimais
3. Configure as configurações de visibilidade da página inicial
4. Visualize as alterações em tempo real
5. Habilite/desabilite a criação pública de mensagens

Para instruções detalhadas de marca, consulte nosso [Guia de Marca](/pt-br/custom-domains/brand-guide).

## Considerações Importantes

- Domínios Personalizados são um recurso premium disponível com o plano Identity.
