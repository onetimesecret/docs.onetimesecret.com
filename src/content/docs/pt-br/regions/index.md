...
3. Para domínios personalizados: Especifique sua região escolhida ao configurar suas configurações de DNS (consulte nosso [Guia de Configuração de Domínio Personalizado](/docs/custom-domains/setup-guide) para instruções detalhadas).
