---
title: Най-добри практики за сигурност
...
2. **Използвайте защита с ключова фраза**: За изключително чувствителна информация използвайте функцията за защита с ключова фраза. Тя добавя допълнително ниво на сигурност, като изисква от получателя да въведе ключова фраза, за да види тайната.
...
4. **Използвайте защитени канали за обмен на метаданни**: Въпреки че Onetime Secret защитава съдържанието на вашата тайна, внимавайте как споделяте връзката и свързаните с нея метаданни (например ключови фрази). Използвайте сигурни, криптирани канали за тази комуникация.
