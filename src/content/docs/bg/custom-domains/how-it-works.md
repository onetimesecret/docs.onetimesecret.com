---
title: Как работят?
description: Персонализираните домейни ви позволяват да хоствате тайно споделяне под ваше собствено име на домейн, с DNS конфигурация във всеки от нашите региони на центрове за данни и допълнителни функции за персонализиране на марката.
---
...
2. Избирате предпочитания от вас регион на центъра за данни.
3. [Конфигурирайте DNS настройките на вашия домейн](/bg/custom-domains/setup-guide), за да сочат към сървърите на Onetime Secret в избрания от вас регион.
...
6. [Персонализирайте външния вид на домейна си](/bg/custom-domains/brand-guide) с лога и цветове на марката чрез интерфейса на администратора.
...
- **Избор на регион**: Ако не сте сигурни кой регион да изберете, консултирайте се с нашето ръководство [Data Center Regions](/bg/regions) или се свържете с нашия екип за поддръжка.

За да научите повече за най-добрите практики за сигурно използване на потребителски домейни, разгледайте нашето ръководство [Най-добри практики за сигурност](/bg/security-best-practices).
