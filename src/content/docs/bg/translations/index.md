...
Ако имате въпроси относно преводите или се нуждаете от съдействие за принос, моля [свържете се с нашия екип](https://onetimesecret.com/feedback) или отворете проблем в нашето [хранилище в GitHub](https://github.com/onetimesecret/onetimesecret).
