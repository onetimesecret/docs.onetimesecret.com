...
3. За персонализирани домейни: Посочете избрания регион при конфигурирането на DNS настройките (за подробни инструкции вижте нашето [Ръководство за настройка на потребителски домейни](/bg/custom-domains/setup-guide)).
