...
6. [Personalice la apariencia de su dominio](/es/custom-domains/brand-guide) con logotipos y colores de marca a través de la interfaz de administración.
...
- **Selección de región**: Si no está seguro de qué región elegir, consulte nuestra guía [Regiones del centro de datos](/es/regions) o póngase en contacto con nuestro equipo de asistencia.
