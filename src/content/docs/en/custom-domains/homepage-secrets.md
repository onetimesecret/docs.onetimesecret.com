---
title: Homepage Secrets
description: Control whether visitors can create and share secrets directly from your branded custom-domain homepage.
---

## What are Homepage Secrets?

When you set up a [custom domain](/en/custom-domains), the address — for example
`secrets.yourbrand.com` — has its own homepage. **Homepage Secrets** is the
setting that controls whether visitors to that homepage can create and share
secrets directly from your branded interface.

You manage this from your **Domain Dashboard** at any time. The setting is
...
- [Brand Guide](/en/custom-domains/brand-guide) — customize the logo and colors shown on this homepage.
