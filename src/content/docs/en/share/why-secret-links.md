...
- **Access notifications**: (On plans that include email notifications) Receive notifications when your secret has been viewed.
...
- **Audit trails**: (Team Plus) Keep track of secret creation and access, helping with compliance requirements.
