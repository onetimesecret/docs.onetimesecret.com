---
title: Privacy First
description: The tracking and marketing practices we deliberately avoid, why we avoid them, and how we keep those commitments verifiable
---

Privacy isn't a feature we bolt onto Onetime Secret — it's how the service is built. That shows up less in what we add than in what we leave out. This page covers the practices we deliberately avoid, why we avoid them, and how you can check that we mean it.
...
The same restraint applies to your inbox. We send no marketing newsletters, promotional offers, or re-engagement campaigns — you'll only hear from us for the service you're using, a notice we owe you, or news you opted into. No email we send contains tracking pixels or click-tracking links, so we don't know whether you opened it or what you clicked. Our [Communication Philosophy](/en/principles/communication) breaks down exactly what we send and why.
