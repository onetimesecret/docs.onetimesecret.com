...
- **[Privacy First](/en/principles/privacy-first)** — the tracking and marketing practices we deliberately avoid, and how we keep those commitments verifiable
- **[Communication](/en/principles/communication)** — why we send as little email as possible, and the three narrow categories we limit ourselves to
- **[Data Minimization](/en/principles/data-minimization)** — what little we store, how long we keep it, and what we never collect
