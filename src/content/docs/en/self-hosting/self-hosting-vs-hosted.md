---
title: "Self-hosting vs. the hosted product"
...
[region](/en/regions) close to your users or your regulators. Self-hosting is
...
see [Simple or Full](./simple-or-full-auth) for that second decision, which only
...
design. Onetime Secret's [share-nothing architecture](/en/regions) means
...
- Ready to self-host: [Self-Hosting Overview](./) and [Getting Started](./getting-started)
- Staying hosted: [Compare plans](/en/pricing/compare-plans) and [choosing a region](/en/regions)
- Already self-hosting: decide your [authentication mode](./simple-or-full-auth)
