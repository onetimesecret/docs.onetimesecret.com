...
La documentation de Onetime Secret est actuellement disponible dans les langues suivantes :

- [**English (en)**](/en/) - Version standard et de référence
- [**Български (bg)**](/bg/) - Bulgare
- [**Dansk (da)**](/da/) - Danois
- [**Deutsch (de)**](/de/) - Allemand
- [**Español (es)**](/es/) - Espagnol
- [**Français (fr)**](/fr/) - Français
- [**Italiano (it)**](/it/) - Italien
- [**日本語 (ja)**](/ja/) - Japonais
- [**한국어 (ko)**](/ko/) - Coréen
- [**Māori (mi)**](/mi/) - Maori
- [**Nederlands (nl)**](/nl/) - Néerlandais
- [**Polski (pl)**](/pl/) - Polonais
- [**Português (pt-BR)**](/pt-br/) - Portugais (Brésil)
- [**Svenska (sv)**](/sv/) - Suédois
- [**Türkçe (tr)**](/tr/) - Turc
- [**Українська (uk)**](/uk/) - Ukrainien
- [**简体中文 (zh-CN)**](/zh-cn/) - Chinois simplifié
...
1. **Localiser le contenu** : Le contenu original en anglais est stocké dans le répertoire `/content/docs/en/`.
...
Pour des traductions cohérentes et de qualité, suivez notre [Guide de style de traduction](/fr/translations/guide) et consultez notre [Glossaire terminologique](/fr/translations/glossary) pour des traductions normalisées de termes clés.
...
Si vous avez des questions sur les traductions ou si vous avez besoin d'aide pour contribuer, veuillez [contacter notre équipe](https://onetimesecret.com/feedback) ou ouvrir un problème sur notre [dépôt GitHub](https://github.com/onetimesecret/onetimesecret).
