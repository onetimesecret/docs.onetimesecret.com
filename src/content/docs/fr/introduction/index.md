...
5. Phrase secrète optionnelle : Ajoutez une couche de sécurité supplémentaire aux secrets partagés
6. Source ouverte : Examinez notre base de code pour une plus grande transparence

## Par où commencer

- **Utiliser le service** — Rendez-vous sur [onetimesecret.com](https://onetimesecret.com/) et partagez un secret en quelques secondes
- **Parcourir la documentation** — Consultez tous les [Guides](/fr/introduction/guides/) pour des tutoriels et des références
- **Intégrer via l'API** — Consultez l'[API REST](/fr/rest-api/) pour un accès programmatique
- **Exécuter votre propre instance** — Suivez le guide d'[auto-hébergement](/fr/self-hosting/)
- **Des questions ?** — [Contactez-nous](https://onetimesecret.com/feedback) directement
