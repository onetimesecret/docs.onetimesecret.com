...
- Choisissez une [région](/fr/regions/) (par exemple, [`us.onetimesecret.com`](https://us.onetimesecret.com/), [`eu.onetimesecret.com`](https://eu.onetimesecret.com/)) pour les centres de données.
