...
:::tip[Version actuelle : v0.26]
La version stable actuelle est **v0.26** (la branche `main`). Elle fonctionne en deux modes :
...
- **Support multilingue** - Disponible dans 17 langues
