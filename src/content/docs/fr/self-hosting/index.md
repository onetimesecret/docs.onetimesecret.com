...
**Si vous souhaitez simplement lancer quelque chose rapidement**, nous recommandons la branche `rel/0.23`. Elle ne nécessite que quelques variables d'environnement et Redis, et nous continuons à y publier des correctifs et de petites mises à jour.
...
Choisissez la méthode de déploiement qui convient le mieux à votre environnement :
...
- **Interface web** - Interface utilisateur complète pour créer et partager des secrets
- **API REST** - Accès programmatique pour les intégrations
- **Support multilingue** - Disponible en plus de 12 langues
- **Domaines personnalisés** - Utilisez votre propre domaine et votre image de marque
