...
2. **Scopo chiaro:** Ogni informazione che raccogliamo ha uno scopo specifico nella fornitura del nostro servizio. Nessun tracciamento, nessuna analisi, nessun extra.
...
3. **Nessun tracciamento:** Non utilizziamo cookie per il monitoraggio, l'analisi o la pubblicità. L'unico cookie che utilizziamo è per mantenere l'accesso se si sceglie di creare un account.
